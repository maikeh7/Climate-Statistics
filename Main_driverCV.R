...
source("/data/mholthui/R_parallel/NewRuns/data_construction.R")
...
scenario = "/data/mholthui/R_parallel/NewRuns/scenario006-Train_on_WRF_preds_crossval.R" #train on BC data, do crossvalidation
VAR  = "tmax"
